...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="img/host2.jpg" class="d-block w-100" alt="..."
					height="500px">
			</div>
			<div class="carousel-item">
	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" src="img/doct.png" height="380px" width="400px">
			</div>
	...
	<div class="container p-2">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct1.jpg" width="230px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct2.jpg" width="230px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct3.jpg" width="230px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct4.jpg" width="230px" height="300px">
